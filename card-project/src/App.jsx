  ...
  return (
    <div className="parent">
      {jobOpenings.map((el, idx) => {
        return <div key={idx}>
          <Card  brandLogo={el.brandLogo} companyName={el.companyName} datePosted={el.datePosted} post={el.post} tag1={el.tag1} tag2={el.tag2} pay={el.pay} location={el.location}/>
        </div>
      })}
    </div>
  );
